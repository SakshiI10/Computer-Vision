# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 12:15:49 2024
...
#We represent shapes with the help of lines and line are expressed for Hough Transform by --
#Cartesian CS(cordinate system) --> y= mx+c and Polar CS --> xcos0+ysin0
"""
import cv2
import numpy as np

img = cv2.imread("D:\\My codes\\Computer Vision\\Image Processing\\Resources\\chess.jpg")
img = cv2.resize(img,(400,400))
gray = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
edges = cv2.Canny(gray,10,200,apertureSize = 3)

'''
#First method of Hough Transformation
